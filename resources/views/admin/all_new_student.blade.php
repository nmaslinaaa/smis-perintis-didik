...
<head>
    ...
    <title>@yield('title', 'Verify New Student')</title>
...
<body>
   ...
   <div class="main-content">
        <div class="dashboard-card">
            <div class="dashboard-title">New Student Registrations</div>
            ...
            <table style="width:100%;border-collapse:collapse;background:#fff;border-radius:8px;overflow:hidden;box-shadow:none;border:1px solid #d9d9d9;">
                <thead>
                    <tr>
                        ...
                        <th style="padding:14px 8px;font-weight:700;font-size:1.08rem;border:1px solid #d9d9d9;text-align:left;background:#fff;">Student Name</th>
                        <th style="padding:14px 8px;font-weight:700;font-size:1.08rem;border:1px solid #d9d9d9;text-align:left;background:#fff;">Parent/Guardian</th>
                        ...
                        <th style="padding:14px 8px;font-weight:700;font-size:1.08rem;border:1px solid #d9d9d9;text-align:center;background:#fff;">Action</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($newStudents as $i => $student)
                    <tr>
                        <td style="text-align:center;border:1px solid #d9d9d9;padding:14px 8px;">{{ $i + 1 }}</td>
                        <td style="font-weight:600;border:1px solid #d9d9d9;padding:14px 8px;">{{ $student->student_name }}</td>
                        <td style="border:1px solid #d9d9d9;padding:14px 8px;">{{ $student->parent ? $student->parent->name : '-' }}</td>
                        <td style="border:1px solid #d9d9d9;padding:14px 8px;">{{ $student->school_name ?? '-' }}</td>
                        <td style="border:1px solid #d9d9d9;padding:14px 8px;">{{ $student->class ? $student->class->class_name : '-' }}</td>
                        <td style="text-align:center;border:1px solid #d9d9d9;padding:14px 8px;">
                            <a href="{{ route('admin.verify_new_student', $student->studentID) }}" class="accept-btn">Edit / Verify</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="6" style="text-align:center;border:1px solid #d9d9d9;padding:14px 8px;">No new student registrations found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
