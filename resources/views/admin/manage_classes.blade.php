...
<div class="main-content">
    <div class="class-list-container">
        <div class="class-list-title">Class List</div>
        <div class="class-list-divider"></div>
        <table class="class-table">
            <thead>
                <tr>
                    <th style="width: 60px;">#</th>
                    <th style="width: 350px;">Class Name</th>
                    <th style="width: 320px;">Total Number of Teachers</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-cell">
                        <a href="{{ url('/admin/edit_class/' . $class->classID) }}" class="action-btn btn-edit">Edit</a>
                        <form method="POST" action="{{ url('/admin/delete_class/' . $class->classID) }}" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this class?');">
                            @csrf
                            @method('DELETE')
