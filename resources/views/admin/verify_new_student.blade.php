...
<body>
   ...
   <div class="main-content">
        <div class="dashboard-card">
            <div class="dashboard-title">Verify Student Application</div>
            <hr class="dashboard-divider">
            <div class="dashboard-info">
                <div class="dashboard-info-col">
                    <ul>
                        <li><strong>Student Name</strong><span>{{ $student->student_name }}</span></li>
                        <li><strong>Email</strong><span>{{ $student->parent ? $student->parent->email : '-' }}</span></li>
                        <li><strong>Phone Number</strong><span>{{ $student->parent ? $student->parent->phonenumber : '-' }}</span></li>
            ...
            <div class="dashboard-actions">
                <form method="POST" action="{{ route('admin.approve_new_student', $student->studentID) }}" style="display:inline;">
                    @csrf
                    <button type="submit" class="accept-btn">Accept</button>
                </form>
                <button type="button" class="reject-btn" onclick="showRejectPopup()">Reject</button>
            </div>
        </div>
    </div>
